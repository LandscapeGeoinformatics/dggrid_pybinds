...
std::vector<unsigned char> SubOpOut::getPRCells()
{
    return (this->prCellOut != nullptr) ?
        std::vector<unsigned char>{this->prCellOut->getData()} : std::vector<unsigned char>{};
}

std::vector<unsigned char> SubOpOut::getCells()
{
    return (this->cellOut != nullptr) ?
           std::vector<unsigned char>{this->cellOut->getData()} : std::vector<unsigned char>{};
}

std::vector<unsigned char> SubOpOut::getCollection()
{
    return (this->collectOut != nullptr) ?
           std::vector<unsigned char>{this->collectOut->getData()} : std::vector<unsigned char>{};
}

std::vector<unsigned char> SubOpOut::getPoints()
{
    return (this->ptOut != nullptr) ?
           std::vector<unsigned char>{this->ptOut->getData()} : std::vector<unsigned char>{};
}

std::vector<unsigned char> SubOpOut::getRPoints()
{
