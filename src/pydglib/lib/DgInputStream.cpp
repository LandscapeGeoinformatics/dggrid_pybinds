...
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
DgInputStream::DgInputStream (const string& fileNameIn,
                              const std::vector<std::string> &blocks,
                              const string& suffixIn,
                              DgReportLevel failLevel)
   : DgBase ("DgInputStream:" + fileNameIn), suffix_ (suffixIn)
{
   this->records.clear();
   this->records.insert(this->records.end(),
                        blocks.begin(),
                        blocks.end());
   for (const std::string &record : this->records) { *this << record << std::endl; }
} // DgInputStream::DgInputStream

////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
bool
DgInputStream::open (const string& fileNameIn,
                     const std::vector<std::string>& blocks,
                     DgReportLevel failLevel)
//
...
//
{
   this->fileName_ = fileNameIn;
   this->records.clear();
   this->records.resize(blocks.size());
   this->records.assign(blocks.begin(), blocks.end());
