...
from pydggrid.Input import Auto, InputTemplate, GDAL, GeoJSON, Location
from pydggrid.Types import Operation, ReadMode, PointDataType, OutputType, OutputAddress
...
class Query(BaseQuery):
    ...
    def set_input(self,
        ...
        elif point_type == PointDataType.GEOJSON:
            self.input = GeoJSON()
            self.Meta.save("point_input_file_type", "GDAL")
        else:
