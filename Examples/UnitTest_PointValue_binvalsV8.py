...
if __name__ == "__main__":
    ...
    document.set_input(PointDataType.GDAL, "../DGGRID/examples/binvalsV8/inputfiles/bridges_2020_WGS84/bridges_2020_WGS84.shp")
    file = open("TestPayload_binvalsV8.hex", "wt")
    file.write(document.input.__bytes__().hex())
    file.close()
    sys.exit(0)
