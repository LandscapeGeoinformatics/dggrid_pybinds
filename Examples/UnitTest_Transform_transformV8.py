...
if __name__ == "__main__":
    ...
    document.input.points("../DGGRID/examples/transformV8/inputfiles/20k.txt")
    document.input.points("../DGGRID/examples/transformV8/inputfiles/50k.txt")
    document.input.points("../DGGRID/examples/transformV8/inputfiles/200k.txt")
    document.input.points("../DGGRID/examples/transformV8/inputfiles/100k.txt")
    # document.set_clip(ClipType.SHAPEFILE, "../DGGRID/examples/superfundGrid/inputfiles/orbuff.shp")
    document.run()
