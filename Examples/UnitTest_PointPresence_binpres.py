...
if __name__ == "__main__":
    ...
    document.input_points("../DGGRID/examples/binpres/inputfiles/20k.txt")
    document.input_points("../DGGRID/examples/binpres/inputfiles/50k.txt")
    document.input_points("../DGGRID/examples/binpres/inputfiles/100k.txt")
    document.input_points("../DGGRID/examples/binpres/inputfiles/200k.txt")
    #
