...
if __name__ == "__main__":
    ...
    document.clip.geo_json("../DGGRID/examples/planetRiskClipMulti/inputfiles/WashingtonDC.geojson")
    document.clip.geo_json("../DGGRID/examples/planetRiskClipMulti/inputfiles/culmenUSA.geojson")
